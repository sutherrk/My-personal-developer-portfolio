...
const experiences = [
  {
    ...
    duration: "2025",
    description:
      "•	6 months of experience as a Frontend Developer, working with HTML, CSS, JavaScript, and modern frameworks. Skilled in React.js, Bootstrap, and Tailwind CSS to create modern and user-friendly interfaces.",
  },
  
  {
    ...
    duration: "2023 - 2024",
    description:
      "•	I have 1 year of experience in graphic designing, creating visually appealing designs for digital and print media. Skilled in using design tools to develop logos, social media posts, banners, and marketing materials.",
  },
{
    role: "MS Office",
    company: "Google",
    duration: "2024 - 2025",
    description:
      "•	Complete 2 years of hands-on experience using MS Office tools including Word, Excel, and PowerPoint. Skilled in document formatting, data entry, basic spreadsheets, and presentations.",
  },
