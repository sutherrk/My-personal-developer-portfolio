        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I am Ramesh Kumar, a dedicated MERN Stack Developer with a passion for building scalable, secure, and lightning-fast web applications. From sleek startups to robust enterprise solutions, I bridge the gap between complex backend logic and intuitive frontend design.
            </p>
